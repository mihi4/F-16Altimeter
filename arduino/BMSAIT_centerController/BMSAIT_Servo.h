...
{// pIN  p_ug  p_og  a_ug  a_og  last  lu
	...
	{A1,   0,   180,   -1000,  1000,    0,   0},  // VVI usually -100 to 100; 
    {A2,   0,   180,   -350,   350,    0,   0},  // AOA  -35 to 35 deg; float value, see above
    //{A3,   0,   180,   0,   1,    0,   0},  // vvi data
	//{A4,   0,   180,   0,   1,    0,   0}  // AOA Flag */
};
