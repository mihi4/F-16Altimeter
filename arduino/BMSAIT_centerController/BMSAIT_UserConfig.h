...
//MODULE SELECTION - uncomment the modules you want to use.
  ...
  // FIXXXME #define LED               //drive LEDs
  //#define LEDMatrix         //drive LED Matrix using a MAX7219 controller
  //#define LED_MM5451        //drive LEDs through one or more MM5451 controller
  ...
  #define AltimeterX27      //drive the altimeter needle with a Xxx.xxx -class stepper motor
...
//BASIC SETTINGS
  ...
  #define POLLTIME 120           // set time between PULL data requests
  #define PULLTIMEOUT 50         // set time to wait for a requested data update defaut: 30ms
  ...
  const char ID[]= "BMSAIT_centerController"; //Set the ID for this arduino program. Use any string. The program will use this ID to check in with the BMSAIT windows application
...
//DATA VARIABLES
  ...
  // 4. Output type (10-LED, 13-LED_MM5451, 20-LCD, 30-MAX7219, 31-TM1637, 40-Servo, 41-ServoPWM, 50-Stepper 28BYJ, 51-Stepper X27-168, 52-StepperBoard VID6606, 60-MotorPoti, 7x-OLED)
  ...
  Datenfeld datenfeld[]=
    {
	  ...
	  // x27 stepper
	   {"ALTN",     "0091", 'i',  54,    0,     0,   0,   0,   0,   "",  "0"}     //Altimeter x27 Stepper for needle
	   // max7219 7seg
	   ,{"ACAL",  "0130", 's',  30,     0,    0,    4,    5,  0,  "1234"}     //
	   ,{"ALT",  "0092", 's',  30,     0,    0,    3,    1,  0,  "567"}     //
       // Servos
	   ,{"PNEU",   "1452", 'b',  40,    0,     0,   0,   0,   0,   "",  "0"}     //Altimeter PneuFlag
	   ,{"KIAS",      "0671", 'i',  40,    1,     0,   0,   0,   0,   "",  "0"}     //ASI knots
       ,{"MACH",   "0680", 'f',  40,    2,     0,   0,   0,   0,   "",  "0"}     //ASI mach        
       ,{"VVI",    "1070", 'f',  40,    3,     0,   0,   0,   0,   "",  "0"}     //VVI
	   ,{"AOA",      "0010", 'f',  40,    4,     0,   0,   0,   0,   "",  "0"}     // AOA
       
      // ,{"VVFLG",  "1472", 'b',  40,    5,     0,   0,   0,   0,   "",  "0"}     //VVI flag       
      // ,{"AOFLG",  "1473", 'b',  40,    6,     0,   0,   0,   0,   "",  "0"}     //AOA flag  
       // LED 
       //,{"BEAC1",   "1481", 'b',  10,    A7,     0,   0,   0,   0,   "",  "False"}     //markr beacon slow blink
       //,{"BEAC2",   "1482", 'b',  10,    A7,     0,   0,   0,   0,   "",  "False"}     //markr beacon fast blink
